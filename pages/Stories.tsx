...
export const Stories: React.FC = () => {
    ...
    return (
        <main className="flex-grow py-8 px-4 sm:px-6 lg:px-8 max-w-[1920px] mx-auto bg-background-light dark:bg-background-dark transition-colors duration-300">
            <div className="max-w-5xl mx-auto space-y-8">
                <div className="text-center space-y-4">
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">光影故事</h1>
                ...
                <div className="grid gap-6">
                    {photos.map((photo, idx) => (
                        <article key={photo.id} className="glass-card flex flex-col md:flex-row gap-6 items-start rounded-2xl overflow-hidden p-5 hover:shadow-lg transition-all duration-300">
